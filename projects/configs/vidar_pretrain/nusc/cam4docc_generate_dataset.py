...
only_generate_dataset = True # only generate cam4docc dataset, no forward
...
train_pipeline = [
    ...
    dict(type='LoadInstanceWithFlow', cam4docc_dataset_path=cam4docc_dataset_path, grid_size=occ_size, use_flow=True, background=empty_idx, pc_range=point_cloud_range,
         use_separate_classes=True, mem_efficient=mem_efficient, time_history_field=queue_length, time_future_field=future_pred_frame_num_train),

    dict(type='DefaultFormatBundle3D', class_names=class_names),
    dict(type='CustomCollect3D', keys=['img', 'aug_param', 'segmentation', 'instance', 'flow', 'occ_label_flag', 'rel_poses', 'gt_modes', 'vel_steering',
...
test_pipeline = [
    ...
    dict(type='PadMultiViewImage', size_divisor=32),
    dict(type='LoadInstanceWithFlow', cam4docc_dataset_path=cam4docc_dataset_path, grid_size=occ_size, use_flow=True, background=empty_idx, pc_range=point_cloud_range,
         use_separate_classes=True, mem_efficient=mem_efficient, time_history_field=queue_length, time_future_field=future_pred_frame_num_test),
    dict(type='DefaultFormatBundle3D', class_names=class_names),
    dict(type='CustomCollect3D', keys=['img', 'segmentation', 'instance', 'flow', 'occ_label_flag', 'rel_poses', 'gt_modes', 'vel_steering',
                                       'sdc_planning', 'sdc_planning_mask', 'command', 'segmentation_bev'])
]
