...
time_receptive_field = queue_length + 1
...
# queue_length = 1 # history frame num input  (不包含ref)
# memory_queue_len = 1 # memory queue
# time_receptive_field = queue_length + 1
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D', keys=['img_inputs_seq', 'gt_occ', 'segmentation', 'instance', 'flow']),
]
