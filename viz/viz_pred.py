...
def viz_occ(occ, occ_mo, file_name, voxel_size, show_so_sem_class, show_mo_time_change, vis_mo):
...
def main():
    ...
    for file_ in tqdm(segmentation_files):
        ...
        viz_occ(gt_occ_semantic_refine, pred_mo_semantic_to_draw, file_, voxel_size=0.2,
